...
- **时间戳优先**：以时间戳较新的数据为准
- **本地优先**：当冲突无法自动解决时，保留本地数据
- **用户确认**：对于重要数据的冲突，提示用户选择
...
该设计支持系统的核心功能，包括用户管理、账套管理、账户管理、交易记录、分类管理、信用卡管理、贷款管理、分期管理、商家管理、项目管理、成员管理和投资管理等。

通过合理的数据库设计和优化，可以确保系统的性能和可靠性，为用户提供流畅的记账体验。