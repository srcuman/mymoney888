      ...
      <form @submit.prevent="addTransaction" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select id="account" v-model="transaction.account" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary dark:bg-gray-700 dark:text-white">
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="(transaction, index) in recentTransactions" :key="index">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm">
                <span :class="transaction.type === 'expense' ? 'text-danger' : 'text-secondary'" class="font-medium">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium" :class="transaction.type === 'expense' ? 'text-danger' : 'text-secondary'">
